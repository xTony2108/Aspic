...
export const Home = () => {
  return (
    <>
      ...
      <section aria-labelledby="servizi-heading" className="px-5">
        <div className="py-2">
          <h2>Scegli il servizio</h2>
          <p>
            Seleziona la prestazione desiderata per procedere con la
            prenotazione. Non è richiesta la registrazione.
          </p>
        </div>
        <div className="flex flex-col py-6 space-y-6 lg:space-y-10">
          <ServiceCard
            ...
            link="/servizi/consulenza-psicologica"
            fullCard={true}
          />
          <ServiceCard
            ...
            link="/servizi/valutazione-psicodiagnostica"
            fullCard={true}
          />
        </div>
