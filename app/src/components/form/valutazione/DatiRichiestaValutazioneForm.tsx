...
const formDatiRichiestaValutazioneSchema = valutazioneSchema
  .pick({
...
type FormSchema = z.infer<typeof formDatiRichiestaValutazioneSchema>;

export const DatiRichiestaValutazioneForm = () => {
  ...
  const {
    ...
    resolver: zodResolver(formDatiRichiestaValutazioneSchema),
    defaultValues: {
