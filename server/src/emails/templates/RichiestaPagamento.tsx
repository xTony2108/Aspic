...
interface RichiestaPagamentoProps {
  firstName: string;
  service: string;
  date: string;
  time: string;
...
export const RichiestaPagamento = ({
  firstName = "Mario",
  service = "Prima Consulenza Psicologica Individuale",
  date = "25/03/2026",
  time = "10:00",
  ...
  <Html lang="it" dir="ltr">
    ...
    <Preview>Completa il pagamento per confermare il tuo appuntamento — ASPIC Psicologia</Preview>
    <Body style={body}>
      <Container style={container}>
        ...
        <Section style={header}>
          <Text style={logoText}>
            ASPIC <span style={logoEm}>Psicologia</span>
          </Text>
          <Text style={headerSub}>Reggio Calabria</Text>
        </Section>
        ...
        <Section style={amountHero}>
          ...
          <Text style={amountService}>{service}</Text>
        </Section>
        ...
        <Section style={content}>
          <Heading style={heading}>
            ...
            <span style={headingEm}>pronto</span>
          </Heading>
          ...
          <Section style={summaryCard}>
            ...
            <Row>
              <Column style={{ ...summaryLabelStyle, fontWeight: 500 }}>Totale</Column>
              <Column style={{ ...summaryValue, fontWeight: 600, fontSize: "16px", color: "hsl(229,54.2%,32.5%)" }}>
                € {amount.toFixed(2)}
              </Column>
            </Row>
          </Section>
          ...
          <Section style={expiryBox}>
            <Text style={expiryText}>
              ...
              <strong>{paymentExpiresAt}</strong>. Dopo tale data sarà necessario
              contattarci per procedere con una nuova richiesta.
            </Text>
          </Section>
...
export default RichiestaPagamento;
...
const amountHero: React.CSSProperties = {
  background: "linear-gradient(135deg, hsl(229,54.2%,32.5%) 0%, hsl(229,40%,50%) 100%)",
  padding: "32px 40px",
  textAlign: "center",
};
